...
export default function GestaoUsuarios({ usuariosIniciais }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex overflow-hidden">
      ...
      {/* ══ SIDEBAR ══ */}
      <Sidebar isOpen={sidebar} activeRoute="/usuarios" />
              ...
              <div className="p-4 border-b border-slate-100 flex flex-col sm:flex-row gap-4 justify-between items-center bg-slate-50/50">
                <div className="relative w-full max-w-md">
                  ...
                  <input 
                    ...
                    className="w-full pl-10 pr-4 py-2 rounded-lg border border-slate-300 bg-white text-sm focus:outline-none focus:border-blue-500 transition-colors"
                    value={searchTerm}
